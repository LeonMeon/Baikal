...
def paz_show_info(path_start, big_list):
    ...
    #res_hists = [hist_train_res, hist_val_res, hist_train_res_angle_cut, hist_val_res_angle_cut]
    #polar_error = [hist_train_polar_error, hist_val_polar_error,  hist_train_polar_error_angle_cut, hist_val_polar_error_angle_cut]  
